...
-- Source: Adapted from phpMyAdmin dump
-- Target: MySQL 8.x+
...
BEGIN
    ...
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET vbFinished = 1;
    ...
    loop_pc: LOOP
        ...
        WHERE cPostalCode = vcPostalCode 
        LIMIT 1;
    END LOOP loop_pc;
...
CREATE TABLE IF NOT EXISTS `postal_code` (
  ...
  `cTownName` VARCHAR(50) DEFAULT NULL,
  PRIMARY KEY (`cPostalCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- INSERT DATA
-- (✂️ Keep your existing INSERT INTO ... VALUES here; it's already compatible)
